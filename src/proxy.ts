...
export const config = {
  matcher: [
    "/((?!login|register|verify-otp|forgot-password|reset-password|landing|api/auth|api/diag|api/stripe/webhook|api/email/webhook|api/cron|_next/static|_next/image|favicon.ico).*)",
  ],
};
